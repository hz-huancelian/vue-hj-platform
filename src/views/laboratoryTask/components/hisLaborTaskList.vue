<template>
  <div>
      ...
      <el-row>
        <el-col :span="20">
          ...
          <el-form-item label="项目名称:">
            <el-input v-model="searchForm.factorName" style="width:165px" placeholder="项目名称" />
          </el-form-item>
          <el-form-item>
    ...
    <el-dialog title="因子详情" :visible.sync="detailVisible" width="80%" top="5vh">
...
export default {
  ...
  methods: {
    handleSearch() {
      checkServer.findHistoryByCondition(this.searchForm).then(res => {
        if (res.code === 200) {
