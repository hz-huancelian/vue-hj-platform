<template>
  <div class="app-continer">
    ...
    >
      ...
      <el-table-column prop="secdClassName" label="检测类别" width="100" align="center" />
      ...
      <el-table-column label="操作" fixed="right" width="190" align="center">
        <template slot-scope="{row}">
          ...
          <!-- <el-button v-if="row.checkStatus>2 && row.dataEntryStep === '1'" type="text" @click="handleLocalDetail(row)">现场记录</el-button> -->
          ...
          <div v-if="row.assignUserId === userId && row.checkStatus==='2' && row.dataEntryStep === '2'" class="erc-divider-vertical" />
          <el-button v-if="row.assignUserId === userId && row.checkStatus==='2' && row.dataEntryStep === '2'" type="text" @click="handleSetResult(row)">结果录入</el-button>
      ...
      <div style="width: 650px;margin:0 auto;">
        <el-form label-width="100px" label-position="left">
          ...
          <el-form-item label="检测结果:">
            <el-row>
              <el-col :span="12">
                <el-input v-model="testResultForm.masterRes" placeholder="结果值">
                  <template slot="append">E</template>
                </el-input>
              </el-col>
              <el-col :span="12">
                <el-input v-model="testResultForm.subRes" placeholder="幂数">
              ...
              <template slot-scope="{row}">
                <el-row>
                  <el-col :span="12">
                    ...
                    <el-input v-model="row.v1" placeholder="结果值">
                      <template slot="append">E</template>
                    </el-input>
                  </el-col>
                  <el-col :span="12">

                    <el-input v-model="row.v2" placeholder="幂数">
                      <template slot="append">{{ testResultForm.unitName }}</template>
                    </el-input>
                  </el-col>
                </el-row>
