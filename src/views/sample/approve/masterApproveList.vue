  ...
  <div>
      ...
      <el-row>
        <el-col :span="20">
          ...
          <el-form-item>
            ...
            <el-button type="primary" @click="handleBatchApprove">批量确认</el-button>
    ...
    <div>
      ...
      >
        ...
        <el-table-column prop="sampleNo" label="样品编号" width="140" align="center" />
        <el-table-column prop="jobId" label="任务单号" width="150px" align="center" />
        <el-table-column prop="inspectionName" label="受检单位" align="center" />
        <el-table-column prop="collectUser" label="采样人" align="center" />
        <el-table-column prop="reviewUser" label="复核人" align="center" />
        ...
        <el-table-column prop="finishTime" label="样品登记时间" width="190px" align="center" />
        ...
        <el-table-column fixed="right" align="center" label="操作" width="90">
          <template slot-scope="scope">
            ...
            <el-button type="text" @click="handleApprove(scope.row)">确认</el-button>
          </template>
        </el-table-column>
      </el-table>
    </div>
...
export default {
  ...
  methods: {
    handleSearch() {
      if (this.sampTaskId !== '') {
        sampleServer.findAuditSampItemForLeaderByCondition(this.searchForm).then(res => {
          if (res.code === 200) {
    ...
    handleBatchApprove() {
      if (this.multipleSelection && this.multipleSelection.length > 0) {
        ...
        this.$message.warning('至少选择一个任务进行信息确认')
      }
    },
    ...
    batchConfirmDialog() {
      this.$confirm('确定提交?', '提示', {
        ...
        sampleServer.batchDoAuditSampItemForLeader(this.batchApprove).then(res => {
          if (res.code === 200) {
            this.$notify({
              title: '成功',
              message: res.message,
    ...
    confirmDialog() {
      this.$confirm('确定提交?', '提示', {
        ...
        sampleServer.doAuditSampItemForLeader(this.approveForm).then(res => {
          if (res.code === 200) {
            this.$notify({
              title: '成功',
              message: res.message,
